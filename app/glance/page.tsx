...
export default function GlancePage() {
  ...
  return <main className="glance-page">
    <nav className="glance-nav"><Link href="/">ALEX / TOOLBOX</Link><span>PERSONAL FEED · DUBAI</span></nav>
    ...
    </section><footer className="glance-footer"><span>INSPIRED BY GLANCE · BUILT FOR ALEX</span><Link href="/">返回全部工具 →</Link></footer>
  </main>;
}
